...
class VanillaTemporalModule(nn.Cell):
    ...
    def construct(self, input_tensor, temb, encoder_hidden_states, attention_mask=None, anchor_frame_idx=None, video_length=None):
        '''
        Args:
...
class TemporalTransformerBlock(nn.Cell):
    def __init__(
        ...
        for block_name in attention_block_types:
            ...
            norms.append(LayerNorm32([dim], epsilon=1.e-5)) # TODO: need fp32?
        ...
        # TODO: check correctness
        self.ff_norm = LayerNorm32([dim], epsilon=1.e-5) # TODO: need fp32?
...
class VersatileAttention(ms.nn.Cell):
    ...
    def construct(self, hidden_states, encoder_hidden_states=None, attention_mask=None, video_length=None):
        ...
        # TODO: encoder_hidden_states is not used actually
