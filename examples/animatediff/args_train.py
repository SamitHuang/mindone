...
def parse_args():
    ...
    parser.add_argument("--vae_fp16", default=None, type=str2bool, help="whether use fp16 precision in vae. If None, it will be set by the value in stable diffusion config yaml")
