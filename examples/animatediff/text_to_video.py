...
from mindone.utils.misc import count_params 
...
def main(args):
    ...
    logger.info("Params: unet3d {:,}, vae {:,}, text encoder {:,}".format(count_params(unet)[0], count_params(vae)[0], count_params(text_encoder)[0]))
