...
class LatentDiffusionWithLossGrad(nn.Cell):
    def __init__(self, network, optimizer, scaler, reducer, overflow_still_update=True, grad_accum_steps=1):
...
class TrainOneStepCellDreamBooth(nn.Cell):
    def __init__(self, model, optimizer, reducer, scaler, overflow_still_update=True, prior_loss_weight=1.0, gradient_accumulation_steps=1):
