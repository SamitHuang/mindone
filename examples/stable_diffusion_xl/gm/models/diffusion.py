...
class DiffusionEngineDreamBooth(DiffusionEngine):
    ...
    def train_step_pynative(self, instance_image, class_image, *all_tokens, grad_func=None):
        ...
        x, noised_input, sigmas, w, cond = self.get_inputs(instance_image, *instance_tokens)
        reg_x, reg_noised_input, reg_sigmas, reg_w, reg_cond = self.get_inputs(class_image, *class_tokens)
