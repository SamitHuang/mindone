...
ckpt_path="outputs/train_lora_r4_clipFixed_noInfNan/2023.11.30-13.26.12/weights/SDXL-base-1.0_15000_lora.ckpt"

prompt=datasets/chinese_art_blip/test/prompts.txt

python demo/sampling_without_streamlit.py \
  --task txt2img \
  --config configs/training/sd_xl_base_finetune_lora_910b.yaml \
  --save_path outputs/lora_cnart_s15000 \
