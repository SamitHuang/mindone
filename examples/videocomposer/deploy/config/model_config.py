...
cfg.scale_factor = 0.18215 # for vae encoder z scaling

# classifier-free guidance.  (use for inference only)
cfg.p_zero = 0.9
#cfg.guide_scale = 9.0 # unconditional guidance scale. tunable for each infer

# stable diffusion
cfg.sd_checkpoint = "model_weights/sd_v2-1_base-7c8d09ce.ckpt"
cfg.sd_config = {
    "double_z": True,
    "z_channels": 4,
    "resolution": 256,
...
cfg.clip_checkpoint = "model_weights/open_clip_vit_h_14-9bb07a10.ckpt"
cfg.clip_tokenizer = "model_weights/bpe_simple_vocab_16e6.txt.gz"
